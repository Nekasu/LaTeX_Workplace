...
\input{body/1_Introduciton/11_intro.tex}


\input{body/2_Background/21background.tex}
\input{body/3_summary_of_agriculture_reomte_sensing/31_summary_of_remote_sensing.tex}
\input{body/3_summary_of_agriculture_reomte_sensing/32_acquisition_of_agricultural_remote_sensing_data.tex}

\input{body/4_processing_datas/41_preprocessing.tex}
\input{body/4_processing_datas/42_featurecapture.tex}
\input{body/4_processing_datas/43_analysis.tex}

\input{body/5_application_of_remote_sensing/51_applications.tex}

\input{body/6_challenges/61_data_get_challenges.tex}
\input{body/6_challenges/63_application_challenges.tex}
\input{body/6_challenges/63_application_challenges.tex}
