...
\begin{tikzpicture}
    ...
    \node at ($(Mi)+(0,-\widthMi/2-0.5)$) (Mi_text) {$[M_{i},M_{i}^{\alpha}]$};
    %为Mi的方格涂上颜色
    %(0,0)
    ...
    \node at ($(Mo)+(0,-\widthMo/2-0.5)$) (Mo_text) {$[M_{o},M_{o}^{\alpha}]$};
    %为Mo的方格涂上颜色
        %(0,0)
    ...
    \node at ($(Ofinal)+(0,-\widthOfinal/2-0.3)$) (Ofinal_text) {$O_{\rm{final}}$};
