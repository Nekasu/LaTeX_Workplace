...
% 我需要修改这一节. method部分应按如下方式展开: 1. 任务设定, 什么是A-NST; 2. α引导的特征传递. 解释该名词, 并介绍本文的实现方法: soft partial convolution; 3. 我的文章结构很像gated covolution一样, 参考gated文章中 method 第三小节怎么写的, 来确定我的文章如何展开.
